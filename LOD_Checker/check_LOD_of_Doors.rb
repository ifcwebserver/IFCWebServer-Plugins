...
module LOD_VA_to_IFC
  ...
  def evaluate(value)
	#Show a red X if the attribte is missing    
...
HTML.h2 "LOD 100 - Conceptgdfgdfgdgual"
IFCDOOR.list "name|globalId|faciltyID|facilityName|facilityDescription|overallWidth|overallHeight|OverallArea:area|PositionType:objectPlacement.to_obj.class"
HTML.h2 "LOD 200-Approximate Geometry"
IFCDOOR.list "name|globalId|storyNumber|floorID|floorName|floorDescription|floorElevation|Type:objectType"
HTML.h2 "LOD 300-Precise Geometry"
IFCDOOR.list "name|globalId|Type:objectType|componentID|componentName|componentDescription"